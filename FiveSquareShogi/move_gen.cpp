...
void genAllSenteBanMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& toMaskBB) {
	using namespace koma;
	genSenteBanMove_koma(en, kyokumen, Koma::s_Fu, false, toMaskBB & bbmask::Dan2to5);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Fu, true, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, false, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, kyokumen.getEachBB(Koma::s_Gin) & bbmask::Dan1, toMaskBB & bbmask::Dan2to5);
	...
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan1, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, false, kyokumen.getEachBB(Koma::s_Hi), toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan1, toMaskBB);
...
void genAllGoteBanMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& toMaskBB) {
	using namespace koma;
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, false, toMaskBB & bbmask::Dan1to4);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, true, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, false, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, kyokumen.getEachBB(Koma::g_Gin) & bbmask::Dan5, toMaskBB & bbmask::Dan1to4);
	...
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan5, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, false, kyokumen.getEachBB(Koma::g_Hi), toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan5, toMaskBB);
...
void genSenteBanMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& toMaskBB) {//不要な不成(歩,香2段目,角,飛)を生成しない
	using namespace koma;
	genSenteBanMove_koma(en, kyokumen, Koma::s_Fu, false, kyokumen.getEachBB(Koma::s_Fu) & bbmask::Dan3to5, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Fu, true, kyokumen.getEachBB(Koma::s_Fu) & bbmask::Dan2, toMaskBB);//4段目から出発したら確実に成れるのでtomaskはそのまま
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, false, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, kyokumen.getEachBB(Koma::s_Gin) & bbmask::Dan1, toMaskBB & bbmask::Dan2to5);
	...
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, false, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan2to5, toMaskBB & bbmask::Dan2to5);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan1, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, false, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan2to5, toMaskBB & bbmask::Dan2to5);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan1, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_nKaku, false, toMaskBB);
	genSenteBanMove_koma(en, kyokumen, Koma::s_nHi, false, toMaskBB);
...
void genGoteBanMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& toMaskBB) {
	using namespace koma;
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, false, kyokumen.getEachBB(Koma::g_Fu) & bbmask::Dan1to3, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, true, kyokumen.getEachBB(Koma::g_Fu) & bbmask::Dan4, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, false, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, kyokumen.getEachBB(Koma::g_Gin) & bbmask::Dan5, toMaskBB & bbmask::Dan4);

	genGoteBanMove_koma(en, kyokumen, Koma::g_Kin, false, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_nFu, false, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_nGin, false, toMaskBB);

	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, false, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan1to4, toMaskBB & bbmask::Dan1to4);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan5, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, false, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan1to4, toMaskBB & bbmask::Dan1to4);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan5, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_nKaku, false, toMaskBB);
	genGoteBanMove_koma(en, kyokumen, Koma::g_nHi, false, toMaskBB);
...
void genSenteBanMove_noMate(GeneratedMoves& en, const Kyokumen& kyokumen, Bitboard toMaskBB) {//不要な不成(歩,香2段目,角,飛),駒損する手,王手を生成しない
	...
	genSenteBanMove_koma(en, kyokumen, Koma::s_Fu, false, kyokumen.getEachBB(Koma::s_Fu) & bbmask::Dan3to5, toMaskBB & ~BBkiki::getStepKiki(Koma::g_Fu, oupos));
	...
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, toMaskBB & bbmask::Dan1 & nomateArea);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Gin, true, kyokumen.getEachBB(Koma::s_Gin) & bbmask::Dan1, toMaskBB & bbmask::Dan2to5 & nomateArea);
	...
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, false, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan2to5, toMaskBB & bbmask::Dan2to5 & ~BBkiki::getDashKiki(allBB, Koma::g_Hi, oupos));
	nomateArea = ~BBkiki::getDashKiki(allBB, Koma::g_nHi, oupos);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1 & nomateArea);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Hi, true, kyokumen.getEachBB(Koma::s_Hi) & bbmask::Dan1, toMaskBB & nomateArea);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, false, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan2to5, toMaskBB & bbmask::Dan2to5 & ~BBkiki::getDashKiki(allBB, Koma::g_Kaku, oupos));
	nomateArea = ~BBkiki::getDashKiki(allBB, Koma::g_nKaku, oupos);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan2to5, toMaskBB & bbmask::Dan1 & nomateArea);
	genSenteBanMove_koma(en, kyokumen, Koma::s_Kaku, true, kyokumen.getEachBB(Koma::s_Kaku) & bbmask::Dan1, toMaskBB & nomateArea);
...
void genGoteBanMove_noMate(GeneratedMoves& en, const Kyokumen& kyokumen, Bitboard toMaskBB) {
	...
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, false, kyokumen.getEachBB(Koma::g_Fu) & bbmask::Dan1to3, toMaskBB & ~BBkiki::getStepKiki(Koma::s_Fu, oupos));
	Bitboard nomateArea = ~BBkiki::getStepKiki(Koma::s_Kin, oupos);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Fu, true, kyokumen.getEachBB(Koma::g_Fu) & bbmask::Dan4, toMaskBB & nomateArea);
	...
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, toMaskBB & bbmask::Dan5 & nomateArea);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Gin, true, kyokumen.getEachBB(Koma::g_Gin) & bbmask::Dan5, toMaskBB & bbmask::Dan1to4 & nomateArea);
	...
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, false, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan1to4, toMaskBB & bbmask::Dan1to4 & ~BBkiki::getDashKiki(allBB, Koma::s_Hi, oupos));
	nomateArea = ~BBkiki::getDashKiki(allBB, Koma::s_nHi, oupos);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5 & nomateArea);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Hi, true, kyokumen.getEachBB(Koma::g_Hi) & bbmask::Dan5, toMaskBB & nomateArea);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, false, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan1to4, toMaskBB & bbmask::Dan1to4 & ~BBkiki::getDashKiki(allBB, Koma::s_Kaku, oupos));
	nomateArea = ~BBkiki::getDashKiki(allBB, Koma::s_nKaku, oupos);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan1to4, toMaskBB & bbmask::Dan5 & nomateArea);
	genGoteBanMove_koma(en, kyokumen, Koma::g_Kaku, true, kyokumen.getEachBB(Koma::g_Kaku) & bbmask::Dan5, toMaskBB & nomateArea);
...
void genSenteUchiMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& blanks) {
	...
	if (kyokumen.getMochigomaNum(Position::m_sFu) > 0) {
		Bitboard UchiFuBB = kyokumen.getEachBB(Koma::s_Fu).getNoFuLines() & blanks & bbmask::Dan2to5;
...
void genGoteUchiMove(GeneratedMoves& en, const Kyokumen& kyokumen, const Bitboard& blanks) {
	...
	if (kyokumen.getMochigomaNum(Position::m_gFu) > 0) {
		Bitboard UchiFuBB = kyokumen.getEachBB(Koma::g_Fu).getNoFuLines() & blanks & bbmask::Dan1to4;
